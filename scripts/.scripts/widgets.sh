...
i3-msg '[class = "Alacritty" instance = "arch"] floating enable, resize set 567 567, move position 326 1406'
i3-msg '[class = "Alacritty" instance = "hexblock"] floating enable, resize set 1550 184, move position 2180 1861'
i3-msg '[class = "Alacritty" instance = "star"] floating enable, resize set 1270 484, move position 183 631'
i3-msg '[class = "Alacritty" instance = "clock"] floating enable, resize set 800 400, move position 2500 300'
