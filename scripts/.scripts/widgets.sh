...
alacritty --hold -t lyrics --class lyrics -o font.size=9 -e sptlrx --current "bold,#F5C2E7" &
sleep 1
...
i3-msg '[class = "lyrics" instance = "lyrics"] kill'
...
i3-msg '[class = "lyrics" instance = "lyrics"] floating enable, resize set 800 400, move position 2500 300'
